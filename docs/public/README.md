...
| [06. 코드 가이드라인](./06_코드가이드라인.md) | 계층별 작성 패턴 — Entity, Repository, Service, Controller, DTO, Exception, Test |
| [07. 배포·운영](./07_배포·운영.md) | 어디에 어떻게 띄우는가 — 배포 구성, 환경 변수, 로그, 헬스체크 |
| [99. 공통 기능](./99_공통.md) | `common/` 패키지 카탈로그 — BaseEntity, 설정, 예외 처리 |
